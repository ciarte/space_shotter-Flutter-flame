...
//   @override
//   Future<List<int>> getFinishedWorlds() async {
//     final prefs = await instanceFuture;
//     final serialized = prefs.getStringList('WorldsFinished') ?? [];

//     return serialized.map(int.parse).toList();
//   }

//   @override
//   Future<void> saveWorldFinished(int world) async {
//     final prefs = await instanceFuture;
//     final serialized = prefs.getStringList('worldsFinished') ?? [];
//     // if (world <= serialized.length) {
//     //   final currentTime = int.parse(serialized[world - 1]);
//     //   if (time < currentTime) {
//     //     serialized[world - 1] = time.toString();
//     //   }
//     // } else {
//     //   serialized.add(time.toString());
//     // }
//     await prefs.setStringList('worldsFinished', serialized);
//   }
...
//     await prefs.remove('worldsFinished');
//   }
// }
